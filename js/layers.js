...
addLayer("m", {
    ...
    baseAmount: () => getBuyableAmount("f",11).add(getBuyableAmount("f",12)), // Get the current amount of baseResource
    getCost() {
    ...
    doReset(layer) {
        ...
        if (layer == this.layer) {
            ...
            setBuyableAmount("f", 12) = new Decimal(0); // Check here if mod breaks
