...
addLayer("R1", {
    layer: "r1", // This is assigned automatically, both to the layer and all upgrades, etc. Shown here so you know about it
    name: "rank1", // This is optional, only used in a few places, If absent it just uses the layer id.
